...
import { UnitsListService } from '../shared/service/units-list.service';
import { IUnitsList } from '../shared/interface/units-list/iUnits-list.interface';
...
export class UnitsListComponent implements OnInit {
  ...
  selectedUnit = (unitsList: IUnitsList) => {
    this.router.navigate(["/units-details", unitsList.id, unitsList.name.replace(/[, ()]+/g, "-").trim()])
  }
}
